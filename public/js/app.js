  ...
  angular.module('Egecms').directive('ngCounterDynamic', function($timeout) {
    return {
      ...
      link: function($scope, $element, $attrs) {
        var counter, getInputLengthOnlyLetters, input, rx, update;
        ...
        update = function() {
          ...
          return input.attr('maxlength', maxlength + (input.val().length - getInputLengthOnlyLetters()));
        };
        getInputLengthOnlyLetters = function() {
          var m;
