...
<a href="{{ App\Models\Folder::getLink(App\Models\Equipment::class) }}" class="list-group-item">Оборудование</a>
...
<a href="{{ App\Models\Folder::getLink(App\Models\Gallery::class) }}" class="list-group-item">Галерея</a>
...
<a href="{{ App\Models\Folder::getLink(App\Models\Page::class) }}" class="list-group-item">Страницы</a>
